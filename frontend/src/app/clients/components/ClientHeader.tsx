...
export default function ClientHeader({ 
  ...
  const [showStatusDropdown, setShowStatusDropdown] = useState(false); // Khôi phục state cho dropdown
  ...
  // Wrapper cho onSearchChange để đặt lại justSelected
  const handleSearchChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setJustSelected(false);
    onSearchChange(e);
  };

  // Tạo gợi ý khi người dùng nhập
  useEffect(() => {
  ...
  // Hàm đóng suggestion window ngay lập tức
  ...
  // Ngăn sự kiện click lan ra ngoài khi click vào form
  ...
  // Xử lý khi người dùng nhấn phím trên bàn phím
      ...
      <div className={`bg-gradient-to-r from-primary-700 via-primary-600 to-primary-400 dark:from-primary-900 dark:via-primary-800 dark:to-primary-600 
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between relative z-10">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white drop-shadow-md">Clients</h1>
              <p className="text-primary-100 dark:text-primary-200">Manage your client relationships</p>
            </div>
          </div>
            ...
            <form ref={searchFormRef} onSubmit={handleSearchSubmit} onClick={handleFormClick}>
              <div className="relative">
                ...
                <Input
                  ...
                  className="py-2.5 pl-10 pr-14 w-full bg-white/80 backdrop-blur-sm dark:bg-gray-700/70 border-purple-200 dark:border-purple-700/50 dark:placeholder-gray-400 transition-all duration-300 focus:shadow-md focus:border-purple-400 dark:focus:border-purple-500"
                  onFocus={() => {
                    if (justSelected) {
                      setShowSuggestions(false);
                      setJustSelected(false);
                  ...
                  <ul>
                    {suggestions.map((client, index) => (
                      ...
                      >
                        ...
                        <div className="ml-3">
                          <div className="font-medium text-gray-900 dark:text-white">{client.shortName || 'N/A'}</div>
